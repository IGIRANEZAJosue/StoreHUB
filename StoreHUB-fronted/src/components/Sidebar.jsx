...
const Sidebar = () => {
  ...
  return (
    <div className="w-full h-full bg-white border-r border-black/10 overflow-y-auto">
      <div className="sticky top-0 bg-white p-4 lg:p-6">
        <div className="flex items-center mb-6 bg-black text-white p-3 rounded-lg">
  ...
  >
    ...
    <span
      className={`transition-colors duration-200 ${
        isSelected ? "text-black font-medium" : "text-black/60"
      }`}
    >
      {label}
    </span>
